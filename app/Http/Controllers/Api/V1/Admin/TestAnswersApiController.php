...
class TestAnswersApiController extends Controller
{
    public function index()
    {
        ...
        return new TestAnswerResource(TestAnswer::with(['test_result', 'question', 'option', 'team'])->get());
    }
    ...
    public function show(TestAnswer $testAnswer)
    {
        ...
        return new TestAnswerResource($testAnswer->load(['test_result', 'question', 'option', 'team']));
    }
