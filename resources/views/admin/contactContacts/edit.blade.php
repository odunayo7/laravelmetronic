...
@section('content')
    ...
    <x-metronic.card flush="true" title="{{ trans('global.edit') }} {{ trans('cruds.contactContact.title_singular') }}">
        <form method="POST" action="{{ route("admin.contact-contacts.update", [$contactContact->id]) }}"
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_first_name') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('contact_first_name', $contactContact->contact_first_name) }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_last_name') ? 'is-invalid' : '' }}"
                    type="text" name="contact_last_name" id="contact_last_name"
                    value="{{ old('contact_last_name', $contactContact->contact_last_name) }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_phone_1') ? 'is-invalid' : '' }}"
                    type="text" name="contact_phone_1" id="contact_phone_1"
                    value="{{ old('contact_phone_1', $contactContact->contact_phone_1) }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_phone_2') ? 'is-invalid' : '' }}"
                    type="text" name="contact_phone_2" id="contact_phone_2"
                    value="{{ old('contact_phone_2', $contactContact->contact_phone_2) }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_email') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('contact_email', $contactContact->contact_email) }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_skype') ? 'is-invalid' : '' }}"
                    type="text" name="contact_skype" id="contact_skype"
                    value="{{ old('contact_skype', $contactContact->contact_skype) }}">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('contact_address') ? 'is-invalid' : '' }}"
                    type="text" name="contact_address" id="contact_address"
                    value="{{ old('contact_address', $contactContact->contact_address) }}">
