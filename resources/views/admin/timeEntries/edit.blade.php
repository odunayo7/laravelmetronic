    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.time-entries.update", [$timeEntry->id]) }}" enctype="multipart/form-data">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid datetime {{ $errors->has('start_time') ? 'is-invalid' : '' }}" type="text" name="start_time" id="start_time" value="{{ old('start_time', $timeEntry->start_time) }}" required>
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid datetime {{ $errors->has('end_time') ? 'is-invalid' : '' }}" type="text" name="end_time" id="end_time" value="{{ old('end_time', $timeEntry->end_time) }}" required>
