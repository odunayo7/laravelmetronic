...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.productCategory.title_singular') }} {{ trans('global.list') }}">
                            ...
                            <td>
                                @can('product_category_show')
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('admin.product-categories.show', $productCategory->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
