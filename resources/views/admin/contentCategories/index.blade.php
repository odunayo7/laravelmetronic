...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.contentCategory.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $contentCategory->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $contentCategory->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $contentCategory->id ?? '' }}
                            ...
                            <td>
                                ...
                                @can('content_category_edit')
                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('admin.content-categories.edit', $contentCategory->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
