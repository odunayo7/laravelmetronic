...
@section('content')
    ...
    <x-metronic.card flush="true" title="{{ trans('global.edit') }} {{ trans('cruds.questionOption.title_singular') }}">
        <form method="POST" action="{{ route("admin.question-options.update", [$questionOption->id]) }}"
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('option_text') ? 'is-invalid' : '' }}"
                    ...
                    value="{{ old('option_text', $questionOption->option_text) }}" required>
