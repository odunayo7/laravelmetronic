...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.assetStatus.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $assetStatus->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $assetStatus->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $assetStatus->id ?? '' }}
                            ...
                            <td>
                                ...
                                @can('asset_status_delete')
                                    <form action="{{ route('admin.asset-statuses.destroy', $assetStatus->id) }}" method="POST"
