...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.crmNote.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $crmNote->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $crmNote->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $crmNote->id ?? '' }}
                            ...
                            <td>
                                ...
                                @can('crm_note_delete')
                                    <form action="{{ route('admin.crm-notes.destroy', $crmNote->id) }}" method="POST"
