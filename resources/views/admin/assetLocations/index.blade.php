...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.assetLocation.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $assetLocation->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $assetLocation->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $assetLocation->id ?? '' }}
                            ...
                            <td>
                                ...
                                @can('asset_location_delete')
                                    <form action="{{ route('admin.asset-locations.destroy', $assetLocation->id) }}" method="POST"
