    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notes.update", [$note->id]) }}" enctype="multipart/form-data">
            ...
            <div class="fv-row mb-7">
                ...
                <textarea class="form-control form-control-solid {{ $errors->has('note_text') ? 'is-invalid' : '' }}" name="note_text" id="note_text" required>{{ old('note_text', $note->note_text) }}</textarea>
