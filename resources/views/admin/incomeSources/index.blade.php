...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.incomeSource.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $incomeSource->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $incomeSource->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $incomeSource->id ?? '' }}
                            ...
                            <td>
                                @can('income_source_show')
                                    <a class="btn btn-xs btn-primary"
                                        href="{{ route('admin.income-sources.show', $incomeSource->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan
                                ...
                                @can('income_source_edit')
                                    <a class="btn btn-xs btn-info"
                                        href="{{ route('admin.income-sources.edit', $incomeSource->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('income_source_delete')
                                    <form action="{{ route('admin.income-sources.destroy', $incomeSource->id) }}" method="POST"
