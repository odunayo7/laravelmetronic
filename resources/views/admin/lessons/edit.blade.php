...
@section('content')
    ...
    <x-metronic.card flush="true" title="{{ trans('global.edit') }} {{ trans('cruds.lesson.title_singular') }}">
        <form method="POST" action="{{ route("admin.lessons.update", [$lesson->id]) }}" enctype="multipart/form-data">
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text"
                    name="title" id="title" value="{{ old('title', $lesson->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="fv-row mb-7">
                ...
                <textarea class="form-control form-control-solid {{ $errors->has('short_text') ? 'is-invalid' : '' }}"
                    name="short_text" id="short_text">{{ old('short_text', $lesson->short_text) }}</textarea>
            ...
            <div class="fv-row mb-7">
                ...
                <textarea class="form-control form-control-solid {{ $errors->has('long_text') ? 'is-invalid' : '' }}"
                    name="long_text" id="long_text">{{ old('long_text', $lesson->long_text) }}</textarea>
            ...
            <div class="fv-row mb-7">
                ...
                <input class="form-control form-control-solid {{ $errors->has('position') ? 'is-invalid' : '' }}"
                    type="number" name="position" id="position" value="{{ old('position', $lesson->position) }}" step="1">
