...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.assetCategory.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $assetCategory->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $assetCategory->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $assetCategory->id ?? '' }}
                            ...
                            <td>
                                ...
                                @can('asset_category_delete')
                                    <form action="{{ route('admin.asset-categories.destroy', $assetCategory->id) }}" method="POST"
