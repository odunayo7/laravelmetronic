...
@section('content')
    ...
    @endcan
    <x-metronic.card flush="true" title="{{ trans('cruds.contentTag.title_singular') }} {{ trans('global.list') }}">
                        ...
                        <tr data-entry-id="{{ $contentTag->id }}">
                            <td>
                                <div class="form-check form-check-sm form-check-custom form-check-solid">
                                    <input class="form-check-input" type="checkbox" value="{{ $contentTag->id }}" />
                                </div>
                            </td>
                            <td>
                                {{ $contentTag->id ?? '' }}
                            ...
                            <td>
                                ...
                                @can('content_tag_delete')
                                    <form action="{{ route('admin.content-tags.destroy', $contentTag->id) }}" method="POST"
